...
export function RestaurantListPage(props: RestaurantListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRestaurants({
        relations: ['user', 'menu.count', 'operational_hours.count', 'seating_layout.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('menu', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('operational_hours', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'operational_hours',
          header: 'Operational Hours',
          accessorKey: 'operational_hours',
          cell: ({ row: { original: record } }: any) => record?._count?.operational_hours,
        }
      : null,
    hasAccess('seating_layout', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'seating_layout',
          header: 'Seating Layout',
          accessorKey: 'seating_layout',
          cell: ({ row: { original: record } }: any) => record?._count?.seating_layout,
        }
      : null,
