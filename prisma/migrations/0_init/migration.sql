...
CREATE TABLE "seating_layout" (
    ...
    CONSTRAINT "seating_layout_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "operational_hours" ADD CONSTRAINT "operational_hours_restaurant_id_fkey" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "seating_layout" ADD CONSTRAINT "seating_layout_restaurant_id_fkey" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
